/**
 * Created by baocheng on 2016/11/14.
 */
$(document).ready(function () {
    ...
    var faceContatiner = $("<div class ='face-container'></div>");
    for(var key in userFaces){
        var img = $("<img src='QQfaces/"+key+"' alt='"+userFaces[key]+"'>");
        faceContatiner.append(img);
    }
    $(".insertFace").append(faceContatiner);
    faceContatiner.hide();
    $(".insertFace").hover(function () {
        faceContatiner.fadeIn("fast",function () {
            faceContatiner.show();
        })
    },function () {
        faceContatiner.hide();
    });
    faceContatiner.on("click","img",function () {
        var content = $(this).attr("alt");
        $("#msgTxt").text( $("#msgTxt").text()+"["+content+"]");
    });
